...
exports.getPackageService = void 0;
...
var getPackageService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var packageId, chosenPackage, error_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, attorneys_db_1.db)('packages')
                        ...
                        .first()];
            case 1:
                chosenPackage = _a.sent();
                if (!chosenPackage) {
                    res.status(404);
                    return [2 /*return*/, (0, mapApiToResponse_1.default)(404, "errors.notFound")];
                }
                res.status(200);
                return [2 /*return*/, (0, mapApiToResponse_1.default)(200, "messages.retrievePackageSuccess", chosenPackage)];
            case 2:
                error_1 = _a.sent();
