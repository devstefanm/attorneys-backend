...
exports.deleteLawyerService = void 0;
...
var deleteLawyerService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var lawyerId, existingLawyer, error_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, attorneys_db_1.db)('lawyers')
                        ...
                        .first()];
            case 1:
                existingLawyer = _a.sent();
                if (!existingLawyer) {
                    res.status(404);
                    return [2 /*return*/, (0, mapApiToResponse_1.default)(404, 'errors.notFound', existingLawyer)];
                }
                // Delete the lawyer with the specified lawyerId
                return [4 /*yield*/, (0, attorneys_db_1.db)('lawyers').where('id', lawyerId).del()];
            case 2:
                // Delete the lawyer with the specified lawyerId
                _a.sent();
                res.status(200); // 200 instead of 204 No Content status for successful deletion because message was not showing
                return [2 /*return*/, (0, mapApiToResponse_1.default)(200, 'messages.lawyerDeleted', existingLawyer.id)];
            case 3:
                error_1 = _a.sent();
