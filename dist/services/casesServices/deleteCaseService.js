...
exports.deleteCaseService = void 0;
...
var deleteCaseService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var caseId, existingCase, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, attorneys_db_1.db)('case_business_numbers').where('case_id', caseId).del()];
            case 3:
                _a.sent();
                // Delete the case with the specified caseId
                return [4 /*yield*/, (0, attorneys_db_1.db)('cases').where('id', caseId).del()];
            case 4:
                // Delete the case with the specified caseId
                _a.sent();
