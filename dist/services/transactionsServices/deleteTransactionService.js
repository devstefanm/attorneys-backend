...
var deleteTransactionService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!existingTransaction) {
                    res.status(404);
                    return [2 /*return*/, (0, mapApiToResponse_1.default)(404, 'errors.notFound', existingTransaction)];
                }
                // Delete the transaction with the specified transactionId
                return [4 /*yield*/, (0, attorneys_db_1.db)('transactions').where('id', transactionId).del()];
            case 2:
                // Delete the transaction with the specified transactionId
                _a.sent();
                res.status(200); // 200 instead of 204 No Content status for successful deletion because message was not showing
                return [2 /*return*/, (0, mapApiToResponse_1.default)(200, 'messages.transactionDeleted', existingTransaction.id)];
            case 3:
                error_1 = _a.sent();
