...
var getTransactionService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var transactionId, transaction, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                transactionId = req.params.transactionId;
                return [4 /*yield*/, (0, attorneys_db_1.db)('transactions as t')
                        .select('t.id', 't.type', 't.amount', 't.posting_method', 't.payment_date', attorneys_db_1.db.raw("json_build_object('id', c.id, 'case_number', c.case_number, 'first_name', p.first_name, 'last_name', p.last_name, 'name', o.name) as case"))
            ...
            case 1:
                ...
                res.status(200);
                return [2 /*return*/, (0, mapApiToResponse_1.default)(200, "messages.retrieveTransactionSuccess", transaction)];
            case 2:
                error_1 = _a.sent();
