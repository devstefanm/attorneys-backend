...
exports.getCourtsListService = void 0;
...
var getCourtsListService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, sort, _c, sortBy, _d, size, _e, page, court, offset, upperCaseCourtsList, totalCountQuery, courtsQuery, nameForSearch, namesArr_1, _f, totalCountResult, courts, totalCourts, totalPages, apiResponse, error_1;
    var _g, _h;
        ...
        switch (_j.label) {
            case 0:
                ...
                totalCountQuery = (0, attorneys_db_1.db)('courts as co')
                    .select(attorneys_db_1.db.raw('COUNT(DISTINCT co.id) as total_courts'))
