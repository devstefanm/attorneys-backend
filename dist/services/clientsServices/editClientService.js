...
var editClientService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientId, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                clientId = req.params.clientId;
                return [4 /*yield*/, (0, universalHelpers_1.editShortNameServiceTemplate)('clients', Number(clientId))(req, res)];
