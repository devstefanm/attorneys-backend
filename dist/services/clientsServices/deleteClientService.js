...
var deleteClientService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientId, existingClient, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                clientId = req.params.clientId;
                return [4 /*yield*/, (0, attorneys_db_1.db)('clients')
                        .select('id')
                        .where('id', clientId)
                        .first()];
            case 1:
                ...
                if (!existingClient) {
                    res.status(404);
                    return [2 /*return*/, (0, mapApiToResponse_1.default)(404, 'errors.notFound', existingClient)];
                }
                // Delete the client with the specified clientId
                return [4 /*yield*/, (0, attorneys_db_1.db)('clients').where('id', clientId).del()];
            case 2:
                // Delete the client with the specified clientId
                _a.sent();
                res.status(200); // 200 instead of 204 No Content status for successful deletion because message was not showing
                return [2 /*return*/, (0, mapApiToResponse_1.default)(200, 'messages.clientsDeleted', existingClient.id)];
            case 3:
                error_1 = _a.sent();
