...
var editExecutorService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var executorId_1, _a, first_name, last_name, email, address, city_id, phone_numbers, existingExecutor, updateExecutorFields, updatedExecutor, apiResponse, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 7, , 8]);
                executorId_1 = req.params.executorId;
                _a = req.body, first_name = _a.first_name, last_name = _a.last_name, email = _a.email, address = _a.address, city_id = _a.city_id, phone_numbers = _a.phone_numbers;
                if (first_name === null ||
                    last_name === null ||
                    first_name === '' ||
                    last_name === '') {
                ...
                return [4 /*yield*/, (0, attorneys_db_1.db)('executors')
                        ...
                        .where('id', executorId_1)
                        .first()];
            case 1:
                existingExecutor = _b.sent();
                if (!existingExecutor) {
                    res.status(404);
                ...
                return [4 /*yield*/, (0, attorneys_db_1.db)('phone_numbers').where('executor_id', executorId_1).del()];
            case 2:
                _b.sent();
            ...
            case 4:
                ...
                if (Object.keys(updateExecutorFields).length === 0 &&
                    (phone_numbers === null || phone_numbers === void 0 ? void 0 : phone_numbers.length) === 0) {
                    res.status(400);
                    return [2 /*return*/, (0, mapApiToResponse_1.default)(400, "errors.nothingChanged")];
                }
                if (!(Object.keys(updateExecutorFields).length > 0)) return [3 /*break*/, 6];
                return [4 /*yield*/, (0, attorneys_db_1.db)('executors')
                        .where('id', executorId_1)
                        .update(updateExecutorFields)
                        .returning('id')];
            case 5:
                updatedExecutor = _b.sent();
                _b.label = 6;
            case 6:
                apiResponse = updatedExecutor[0];
                res.status(200);
                return [2 /*return*/, (0, mapApiToResponse_1.default)(200, "messages.editExecutorSuccess", apiResponse)];
            case 7:
                error_1 = _b.sent();
