...
var createExecutorService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, first_name, last_name, email, address, city_id, phone_numbers, newExecutorId_1, apiResponse, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                if (!newExecutorId_1) return [3 /*break*/, 6];
            ...
            case 5:
                ...
                res.status(200);
                return [2 /*return*/, (0, mapApiToResponse_1.default)(200, "messages.createExecutorSuccess", apiResponse)];
            case 6:
                res.status(404);
