...
exports.getFullNamesServiceTemplate = exports.getShortNamesServiceTemplate = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    searchTerms = (0, searchHelper_1.specialCharactersChecker)(searchTerm);
                    if (search) {
                        (0, searchHelper_1.generateShortNameSearchQuery)(query, searchTerms);
                    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    searchTerms = (0, searchHelper_1.specialCharactersChecker)(searchTerm);
                    if (search) {
                        (0, searchHelper_1.generateFullNameSearchQuery)(query, searchTerms);
                    }
                    return [4 /*yield*/, query];
                case 1:
