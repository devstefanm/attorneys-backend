...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.alterTable('cases', function (table) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, knex.schema.alterTable('executors', function (table) {
                            table.string('email').nullable().alter();
                        })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, knex.schema.alterTable('debtors', function (table) {
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, knex.schema.alterTable('people', function (table) {
                            table.unique(['jmbg']);
                        })];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, knex.schema.alterTable('organizations', function (table) {
                            table.unique(['pib']);
                        })];
                case 6:
                    _a.sent();
